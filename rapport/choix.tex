...
cases (sur une meme ligne donc continue en mémoire, virtuelle tout du
moins).
...
Au final nous n'avons pas obtenus les performances espérée puisque la
gestion des différents registres prend plus de temps que d'effectuer 4
calculs. Cependant peut-être qu'avec des registre de 512 bits (AVX)
nous aurions obtenus de meilleurs résultats.
\medskip
